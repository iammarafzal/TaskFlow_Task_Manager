...
import { Hexagon, Mail, Lock, User as UserIcon, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#090d16] flex items-center justify-center p-4 selection:bg-blue-500/30">
      ...
      >
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-slate-100 tracking-tight">ObsidianFlow HQ</h1>
          <p className="text-slate-500 text-sm mt-2">The cinematic minimalist task engine.</p>
        </div>
        ...
        <div className="bg-[#111726]/60 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <label className="text-xs font-medium text-slate-500 mb-1.5 block uppercase tracking-wider">Secure Password</label>
              <div className="relative">
          ...
          <div className="mt-6 pt-6 border-t border-white/[0.06] text-center">
            ...
            >
              {isLogin ? "Don't have an clearance? Request Access" : "Already provisioned? Authenticate"}
            </button>
          </div>
        </div>
      </motion.div>
